    ...
    <div className='mt-[90px] py-10 px-5 w-full h-auto flex flex-wrap justify-between items-center'>
      <div className='lg:w-1/2 md:w-1/2 w-full h-full'>
        <div className='space-y-7 text-2xl flex flex-col'>
          ...
          <a href={cv} download={cv} className='mt-10 outline outline-red-500 text-red-500 font-bold text-2xl w-full h-20 rounded-full hover:bg-red-500  hover:text-white p-5 text-center border-none'>DOWNLOAD CV</a>
        </div>
      </div>
